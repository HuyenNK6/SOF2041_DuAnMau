 ...
 * @author Huyen
 */
public class NhanVienViewTemplate extends javax.swing.JFrame {

    /**
     * Creates new form NhanVienView
     */
    public NhanVienViewTemplate() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhanVienViewTemplate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NhanVienViewTemplate().setVisible(true);
            }
        });
    }
